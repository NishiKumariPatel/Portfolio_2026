...
const ROWS = [
  [
    ...
    { title: "Backend & API", items: ["FastAPI", "Flask", "REST API", "HTML5", "CSS3"] },
    { title: "Cloud & Databases", items: ["AWS (Lambda, S3)", "Firebase", "MongoDB", "Supabase"] },
    { title: "AI & ML", items: ["Scikit-learn", "SHAP", "NumPy", "Pandas", "Predictive Modeling"] },
  ],
  [
    {
      title: "Core Concepts",
